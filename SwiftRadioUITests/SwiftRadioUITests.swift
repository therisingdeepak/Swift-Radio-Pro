...
class SwiftRadioUITests: XCTestCase {
    ...
    let hamburgerMenu = XCUIApplication().navigationBars["Nepali Bhajan Radio"].buttons["icon hamburger"]
    ...
    func testMainStationsView() {
        ...
        app.navigationBars["Nepali Bhajan Radio"].buttons["btn nowPlaying"].tap()
        waitForStationToLoad()
